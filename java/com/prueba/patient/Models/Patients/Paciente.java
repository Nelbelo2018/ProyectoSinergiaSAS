...
public class Paciente{
    ...
    @ManyToMany
    @JsonBackReference
    @JoinTable(name = "paciente_departamentos",joinColumns = @JoinColumn(name = "paciente_id",
    referencedColumnName = "paciente_id"),inverseJoinColumns = @JoinColumn(name = "departamento_id",
